...
def get_data(trn_data, tst_data, classes, num_tasks, nc_first_task, validation, shuffle_classes, class_order=None):
    ...
    for this_image, this_label in zip(trn_data['x'], trn_data['y']):
        ...
        mapping[this_label] = classes[old_label]
        mapping_id[old_label] = this_label
    ...
    return data, taskcla, class_order, mapping, mapping_id
