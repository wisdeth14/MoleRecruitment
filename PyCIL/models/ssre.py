...
class SSRE(BaseLearner):
    def __init__(self, args):
        ...
        self._network = IncrementalNet(args=args, pretrained=False)
        self._protos = []
    ...
    def incremental_train(self, data_manager, mole_indices):
        ...
        print(np.arange(self._known_classes, self._total_classes))
    ...
    def eval_task(self):
        ...
        for i, l in enumerate(y_true):
            self.confusion_matrix[l.item(), y_pred[i][0].item()] += 1
