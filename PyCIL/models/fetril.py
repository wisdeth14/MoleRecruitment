...
class FeTrIL(BaseLearner):
    ...
    def incremental_train(self, data_manager, mole_indices):
        ...
        self._train(self.train_loader, self.test_loader, mole_indices)
        ...
        if mole_indices:
            ...
            self._epoch_num = 1
            self._train(self.mole_loader, self.test_loader, mole_indices)
    ...
    def _train(self, train_loader, test_loader, mole_indices):
